/**
  You need to create an express HTTP server in Node.js which will handle the
   logic of a file server.
  ...
  2. GET /file/:filename - Returns content of given file by name
     ...
     Response: 200 OK with the file content as the response body if found,
      or 404 Not Found if not found. Should return `File not found` as text 
